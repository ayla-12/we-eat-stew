	...
	luck: [
		{
			...
			title: 'CLOVER',
			artist: '프로미스나인',
			lyrics: `잡힐 듯 잡히지 않았던 미래에
세 잎 클로버처럼 안아주고 싶어`,
			timestamp: 69,
			link: 'https://youtu.be/6TWeJ9A8LHg?si=IXEhhXGnSiWejo3X',
		},
		{
			id: 2000223,
			title: '행운을 빌어',
	...
	trip: [
		{
			...
			title: 'Hitchhiker',
			artist: '츄',
			lyrics: `예측할 수 없는 일이 생길걸
숨을 훅 고르고 둘러보는 나만의 earth`,
			timestamp: 171,
			link: 'https://youtu.be/zpIFYeT8l0Y?si=Fkls9GLZfTCevrMA',
		},
		{
			id: 2000207,
			title: 'Dun Dun Dance',
...
한남동 UN Village hill`,
		...
		},
		{
			...
			artist: 'Jay Park',
			lyrics: `나 지금 5천만원짜리 시계 찼지만
나는 너를 훨씬 아끼지 babe`,
			timestamp: 34,
			link: 'https://youtu.be/JPTunZy4Fl8?si=t2D3gGE9azUQ6-uh',
		},
		{
			id: 2000200,
			title: 'Underwater',
